          ...
          <div className="mt-9 grid grid-cols-1 gap-x-4 gap-y-8 xl:grid-cols-3">
            {projects.map((project, i) => (
              ...
              >
                ...
                >
                  <div className="group-hover:bg-dark/20 absolute inset-0 z-10 flex items-center justify-center transition-all duration-500 ease-in-out">
                    <Link
                      ...
                      href={`/${project.slug}`}
                      className="bg-dark/80 focus-visible:ring-dark/40 flex cursor-pointer items-center justify-center rounded-full p-5 opacity-0 backdrop-blur-sm transition-all duration-500 ease-in-out group-hover:opacity-100 focus-visible:ring-2"
                    >
                ...
                <h3
                  itemProp="name"
                  className="text-dark mt-1 text-[28px] font-medium xl:text-4xl"
                >
